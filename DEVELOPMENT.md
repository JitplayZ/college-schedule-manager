...
```bash
git remote add encore encore://college-schedule-manager-96bi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/college-schedule-manager-96bi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/college-schedule-manager-96bi/settings/integrations/github)
